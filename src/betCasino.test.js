...
it("Logica das estrategias #2", () => {
    ...
    expect(strategy.strategies).toStrictEqual([{"count": 1, "name": "Duzia 01"}, {"count": 1, "name": "Par"}])
    balls.unshift(8)
    strategy = analiseStrategy(balls, strategy)
    console.log(strategy)
    expect(strategy.strategies).toStrictEqual([{"count": 2, "name": "Duzia 01"}, {"count": 2, "name": "Par"}])
    balls.unshift(14)
    strategy = analiseStrategy(balls, strategy)
    console.log(strategy)
